                    ...
                    <Flex height='100vh' overflowY={'scroll'} >
                        <Container display={'flex'} flexDirection={'column'}  align='center' justifyContent='center'  direction="column"  minHeight='100vh'>
                            ...
                            <Box mb={'auto'} className="Box-card" py='2rem' px={'2.5rem'} bg='#fff' borderRadius='0' boxShadow={'0px 1px 3px rgba(32, 31, 31, 0.1), 0px 1px 2px rgba(32, 31, 31, 0.06)'}  >
                                ...
                                <Flex mb={'2rem'}>
                                    {!showNext?
                                    <Link onClick={handleBackLogin}  color='#4D4D4D' fontWeight='500' display='flex' alignItems={'center'} justifyContent={'center'} color={'#0F0EA7'} fopntWeight={'500'} ><IoIosArrowBack /> <Text as='span'  ml={'10px'}> Back to sign in</Text></Link>
                                    :
                                    <Link onClick={handleBackForgot}  color='#4D4D4D' fontWeight='500' display='flex' alignItems={'center'} justifyContent={'center'} color={'#0F0EA7'} fopntWeight={'500'} ><IoIosArrowBack /> <Text as='span'  ml={'10px'}> Back to forgot password</Text></Link>
                                    }
                                </Flex>
                                {showNext?
                                <Box textAlign={'left'}>
